"""
Adopted from  Kimin Lee Sun Oct 21 2018
"""
...
parser = argparse.ArgumentParser(description='PyTorch code: Residual flow regression using adversarial samples')
...
def main():
    ...
    for dataset in dataset_list:
        ...
        outf = './output/' + args.net_type + '_' + dataset + 'RealNVP_magnitude' + '/'
        outf_FGSM = './output/' + args.net_type + '_' + dataset + 'RealNVP_magnitude' + '/'
        ...
        for out in out_list:
            ...
            for score in score_list:
                total_X_FGSM, total_Y_FGSM = lib_regression.load_characteristics_RealNVP(score, dataset, 'FGSM', outf_FGSM, args.net_type, num_classes)
                X_val_FGSM, Y_val_FGSM, X_test_FGSM, Y_test_FGSM = lib_regression.block_split_adv_RealNVP(total_X_FGSM, total_Y_FGSM)
                ...
                X_val, Y_val, X_test, Y_test = lib_regression.block_split_RealNVP(total_X, total_Y, out)
